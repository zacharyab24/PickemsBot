...
func TestStoreLeaderboard_MultipleEntries(t *testing.T) {
	...
	mt.Run("successfully stores leaderboard with multiple entries", func(mt *mtest.T) {
		...
		leaderboard := Leaderboard{
			...
			UpdatedAt: time.Now(),
			Entries: []LeaderboardEntry{
				{UserID: "user1", Username: "FirstPlace", Score: 100, ScoreResult: models.ScoreResult{Successes: 50, Pending: 0, Failed: 0}},
				{UserID: "user2", Username: "SecondPlace", Score: 90, ScoreResult: models.ScoreResult{Successes: 45, Pending: 0, Failed: 5}},
				{UserID: "user3", Username: "ThirdPlace", Score: 80, ScoreResult: models.ScoreResult{Successes: 40, Pending: 0, Failed: 10}},
				{UserID: "user4", Username: "FourthPlace", Score: 70, ScoreResult: models.ScoreResult{Successes: 35, Pending: 0, Failed: 15}},
				{UserID: "user5", Username: "FifthPlace", Score: 60, ScoreResult: models.ScoreResult{Successes: 30, Pending: 0, Failed: 20}},
			},
		}
